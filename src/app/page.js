    ...
    <main>
      ...
      <div className="min-h-screen bg-[#d8d8d8] flex-col justify-center w-screen overflow-hidden relative ">
        {animationComplete ? (
          ...
          >
            <div
              className={`text-[#272727] font-semibold text-[26px] flex justify-center items-center gap-2 ${poppins.className}`}
            >
            ...
            <div className="text-[#272727] text-[16px] font-[600] flex gap-1">
              <Link href="/about" className="hover:text-[#6f6e6e]">
                About,
              </Link>
              <Link href="/work" className="hover:text-[#6f6e6e]">
                Work,
              </Link>
              <Link href="/contact" className="hover:text-[#6f6e6e]">
                Contact
              </Link>
            </div>
          </div>
        ...
        {animationComplete ? (
          <div
            className={`text-[140px] w-screen px-[20px] flex justify-between font-medium absolute bottom-[10px] gap-[5px] leading-[140px] m-auto text-[#272727] ${poppins.className} ${
              animationComplete ? "custom-fade-in-left" : ""
            }`}
          >
            <span>TARANG</span>
